...
import com.example.videosdktutorial.adapter.ParticipantAdapter
...
class MeetingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val participantName = "Praveen Kumar"
        ...
        shareMeetingId(meetingId.toString())
    }

    private fun shareMeetingId(meetingId: String) {
        val imgShareMeetingId = findViewById<ImageView>(R.id.imgShareMeetingId)
        imgShareMeetingId.setOnClickListener {
            val intent = Intent(Intent.ACTION_SEND)
            intent.type = "text/plain"
            intent.putExtra(Intent.EXTRA_TEXT, meetingId)
           startActivity(Intent.createChooser(intent, meetingId))
        }
    }
